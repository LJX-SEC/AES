...
//AES-128
#define Nkl 16 //length of key
#define Nb 4 //number of columns comprising a state
#define Nk 4 //number of 32bit words in key
#define Nr 10 //number of rounds

#define writeEncFile 0

unsigned char state[4][4] = {0x00, };

long long int binarySize = 0x00;
unsigned char padData = 0x00;
unsigned char keySize = 0x00;

unsigned char *binary = (unsigned char *)0x00;
unsigned char *key = (unsigned char *)0x00;

unsigned char roundKey[Nkl * (10 + 1)] = {0x00,};
